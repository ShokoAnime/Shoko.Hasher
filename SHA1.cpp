...
void CSHA1::GetHash(__in_bcount(20) uchar* pHash) const
{
...
#else
extern "C" void __stdcall SHA1_Add_p5(CSHA1::SHA1State*, const void* pData, std::size_t nLength);
#endif
void CSHA1::Add(const void* pData, std::size_t nLength)
{
#if (defined(_WIN64) || defined(__x86_64__))
...
CSHA1::TransformArray::TransformArray(const uint32* const buffer)
{
...
namespace
{
	...
	__forceinline void F(const CSHA1::TransformArray& data, uint32& a, uint32& b, uint32 c, uint32 d, uint32 e, uint32& t)
	{
		t = a;
	...
	template< uint32 round >
	__forceinline void G(const CSHA1::TransformArray& data, uint32& a, uint32& b, uint32 c, uint32 d, uint32 e, uint32& t)
	{
		t = a;
	...
	// maj transformation
	template< uint32 round >
	__forceinline void H(const CSHA1::TransformArray& data, uint32& a, uint32& b, uint32 c, uint32 d, uint32 e, uint32& t)
	{
		t = a;
	...
	// parity transformation
	template< uint32 round >
	__forceinline void I(const CSHA1::TransformArray& data, uint32& a, uint32& b, uint32 c, uint32 d, uint32 e, uint32& t)
	{
		t = a;
...
void CSHA1::Transform(TransformArray w)
{
